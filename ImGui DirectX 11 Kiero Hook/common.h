...
const static auto BG_UnlockablesAttachmentIsRestricted = reinterpret_cast<bool(__fastcall*)(unsigned int itemIndex, unsigned int attachment)>(ProcessBase + 0x26276D0);
...
const static auto BG_UnlockablesGetItemAttachment = reinterpret_cast<__int64(__fastcall*)(eModes eMode, int itemIndex, int attachmentNum)>(ProcessBase + 0x262D750);
...
const static auto BG_UnlockablesSetClassSetName = reinterpret_cast<bool(__fastcall*)(int controllerIndex, int classSetType, int classSetIndex, const char* classSetName)>(ProcessBase + 0x2634CF0); 
...
const static auto CL_Rank_GetDisplayLevel = reinterpret_cast<const char*(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA2D0);
const static auto CL_Rank_GetFullName = reinterpret_cast<const char*(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA340);
const static auto CL_Rank_GetIcon = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank, const int prestige, GfxImage **handle)>(ProcessBase + 0x13CA3B0);
const static auto CL_Rank_GetIconName = reinterpret_cast<const char*(__fastcall*)(eModes mode, const int rank, const int prestige)>(ProcessBase + 0x13CA3E0);
const static auto CL_Rank_GetInGameName = reinterpret_cast<const char*(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA4A0);
const static auto CL_Rank_GetMaxXP = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA510);
const static auto CL_Rank_GetMinXP = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA570);
const static auto CL_Rank_GetParagonDisplayLevel = reinterpret_cast<char* (__fastcall*)(unsigned int mode, int iconId, char** outName)>(ProcessBase + 0x13CA5D0);
const static auto CL_Rank_GetParagonIcon = reinterpret_cast<const char*(__fastcall*)(unsigned int mode, int iconId, GfxImage **handle)>(ProcessBase + 0x13CA5E0);
const static auto CL_Rank_GetParagonIconName = reinterpret_cast<const char* (__fastcall*)(unsigned int mode, int iconId)>(ProcessBase + 0x13CAD20);
const static auto CL_Rank_GetParagonMaxXP = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA640);
const static auto CL_Rank_GetParagonMinXP = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA6A0);
const static auto CL_Rank_GetParagonRankForXP = reinterpret_cast<__int64(__fastcall*)(eModes mode, const int rank)>(ProcessBase + 0x13CA700);
const static auto CL_Rank_GetParagonXPCap = reinterpret_cast<__int64(__fastcall*)(eModes mode)>(ProcessBase + 0x13CA780);
const static auto CL_Rank_GetPrestigeCap = reinterpret_cast<__int64(__fastcall*)(eModes mode)>(ProcessBase + 0x13CA810);
const static auto CL_Rank_GetRankForXP = reinterpret_cast<int(__fastcall*)(eModes mode, const int xp)>(ProcessBase + 0x13CA8A0);
const static auto CL_Rank_GetStarterPackXPCap = reinterpret_cast<int(__fastcall*)(eModes mode, const int xp)>(ProcessBase + 0x13CA920);
const static auto CL_Rank_GetUnlocks = reinterpret_cast<char*(__fastcall*)(eModes mode)>(ProcessBase + 0x13CA9C0);
const static auto CL_Rank_GetXPCap = reinterpret_cast<__int64(__fastcall*)(eModes mode)>(ProcessBase + 0x13CAA20);
...
const static auto Com_GametypeSettings_IsAttachmentRestricted = reinterpret_cast<bool(__fastcall*)(int32_t attachmentIndex, int32_t itemIndex, bool getDefault)>(ProcessBase + 0x20E8F30);
...
const static auto DDL_MoveToIndex = reinterpret_cast<bool(__fastcall*)(DDLState * fromState, DDLState * toState, int index)>(ProcessBase + 0x24A99A0);
...
const static auto LiveStats_GetArenaPoints = reinterpret_cast<int(__fastcall*)(int controllerIndex, int slotIndex)>(ProcessBase + 0x1E906E0);
...
const static auto LiveStats_GetXp = reinterpret_cast<unsigned int(__fastcall*)(eModes mode, int controllerIndex)>(ProcessBase + 0x1E93180);
...
const static auto LiveStats_MoveToArenaSlot = reinterpret_cast<bool(__fastcall*)(DDLState* resultState, int slotIndex)>(ProcessBase + 0x1E94860);
const static auto LiveStats_MoveToSkillAndVariance = reinterpret_cast<bool(__fastcall*)(eModes mode, DDLState * skillState, DDLState * varianceState, DDLState * onboardingState)>(ProcessBase + 0x1E94E50);
...
const static auto LobbyData_GetAttachmentVoteType = reinterpret_cast<__int64(__fastcall*)(unsigned int attachment)>(ProcessBase + 0x1EF32E0);
const static auto LobbyData_ItemAttachmentIsBanned = reinterpret_cast<bool(__fastcall*)(unsigned int itemIndex, unsigned int attachment)>(ProcessBase + 0x1EF3600);
...
const static auto SV_GetClientIntStat = reinterpret_cast<__int64(__fastcall*)(ClientNum_t clientNum, const DDLState * searchState)>(ProcessBase + 0x21EB3C0);
