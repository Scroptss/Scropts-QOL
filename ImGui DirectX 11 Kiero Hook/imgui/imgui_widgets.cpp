...
bool ImGui::sub(const char* icon, const char* label, bool selected)
{
    ...
    const ImGuiStyle& style = g.Style;
    const ImGuiID id = window->GetID(label);
    const ImVec2 label_size = ImGui::CalcTextSize("amogus", NULL, true);
    ...
    if (selected)
    {
        window->DrawList->AddRectFilled(ImVec2(bb.Min.x + 5, bb.Min.y - 1), ImVec2(bb.Max.x + 10, bb.Max.y + 0), ImColor(43, 43, 40, 255));
        draw->AddRectFilled(ImVec2(bb.Min.x + 5, bb.Min.y - 1), ImVec2(bb.Max.x - 147, bb.Max.y + 0), GetColorU32(ImGuiCol_SubTab));
        draw->AddRectFilled(ImVec2(bb.Min.x - 0, bb.Min.y - 1), ImVec2(bb.Max.x - 147, bb.Max.y + 0), GetColorU32(ImGuiCol_SubTab), 15);
    ...
    else
    {
        ...
        {
            window->DrawList->AddRectFilled(ImVec2(bb.Min.x + 5, bb.Min.y + 0), ImVec2(bb.Max.x + 10, bb.Max.y + 0), ImColor(32, 31, 32, 255));
            window->DrawList->AddRectFilled(ImVec2(bb.Min.x - 1, bb.Min.y + 0), ImVec2(bb.Max.x - 147, bb.Max.y + 0), ImColor(32, 31, 32, 255), 15);
        }
    }
    ...
    if (selected)
    {
        ...
        ImGui::RenderText(ImVec2(bb.Min.x + 0 + (180 / 2 - label_size.x / 2), bb.Min.y + style.FramePadding.y + 6), label);
        ImGui::RenderText(ImVec2(bb.Min.x + 0 + (110 / 2 - label_size.x / 2), bb.Min.y + style.FramePadding.y + 7), icon);
        //ImGui::PopStyleColor();
    }
    else
    {
