...
#include <functional>		// For storing the code, which executes on the button click in the notification
...
#define NOTIFY_RENDER_LIMIT					10			// Max number of toasts rendered at the same time. Set to 0 for unlimited
